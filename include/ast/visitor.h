...
class ASTVisitor {
 public:
  ...
  virtual void visit(
      class ProgramHeadNode_Program_Id_Lparen_Idlist_Rparen &node) = 0;
  ...
  virtual void visit(
      class ConstDeclNode_ConstDecl_Semicolon_Id_Assignop_ConstVal &node) = 0;
  ...
  virtual void visit(
      class TypeNode_Array_Lbracket_Period_Rbracket_Of_BasicType &node) = 0;
  ...
  virtual void visit(
      class PeriodNode_Period_Comma_Number_Dot_Dot_Number &node) = 0;
  ...
  virtual void visit(
      class VarDeclNode_VarDecl_Semicolon_IdList_Colon_Type &node) = 0;

  virtual void visit(class SubprogramDeclsNode &node) = 0;
  virtual void visit(
      class SubprogramDeclsNode_SubprogramDecls_Subprogram &node) = 0;

  virtual void visit(class SubprogramNode &node) = 0;
  virtual void visit(
      class SubprogramNode_SubprogramHead_Semicolon_SubprogramBody &node) = 0;

  virtual void visit(class SubprogramHeadNode &node) = 0;
  virtual void visit(
      class SubprogramHeadNode_Procedure_Id_FormalParameter &node) = 0;
  virtual void visit(
  ...
  virtual void visit(
      class FormalParameterNode_Lparen_ParameterList_Rparen &node) = 0;

  virtual void visit(class ParameterListNode &node) = 0;
  virtual void visit(class ParameterListNode_Parameter &node) = 0;
  virtual void visit(
      class ParameterListNode_ParameterList_Semicolon_Parameter &node) = 0;
  ...
  virtual void visit(
      class CompoundStatementNode_Begin_StatementList_End &node) = 0;

  virtual void visit(class StatementListNode &node) = 0;
  virtual void visit(class StatementListNode_Statement &node) = 0;
  virtual void visit(
      class StatementListNode_StatementList_Semicolon_Statement &node) = 0;

  virtual void visit(class StatementNode &node) = 0;
  virtual void visit(
      class StatementNode_Variable_Assignop_Expression &node) = 0;
  ...
  virtual void visit(
      class StatementNode_If_Expression_Then_Statement_ElsePart &node) = 0;
  virtual void visit(
      class StatementNode_For_Id_Assignop_Expression_To_Expression_Do_Statement
          &node) = 0;
  virtual void visit(
      class StatementNode_Read_Lparen_VariableList_Rparen &node) = 0;
  virtual void visit(
      class StatementNode_Write_Lparen_ExpressionList_Rparen &node) = 0;

  virtual void visit(class VariableListNode &node) = 0;
  virtual void visit(class VariableListNode_Variable &node) = 0;
  virtual void visit(
      class VariableListNode_VariableList_Comma_Variable &node) = 0;
  ...
  virtual void visit(
      class IdVarPartNode_Lbracket_Expression_Rbracket &node) = 0;

  virtual void visit(class ProcedureCallNode &node) = 0;
  virtual void visit(class ProcedureCallNode_Id &node) = 0;
  virtual void visit(
      class ProcedureCallNode_Id_Lparen_ExpressionList_Rparen &node) = 0;
  ...
  virtual void visit(
      class ExpressionListNode_ExpressionList_Comma_Expression &node) = 0;

  virtual void visit(class ExpressionNode &node) = 0;
  virtual void visit(class ExpressionNode_SimpleExpression &node) = 0;
  virtual void visit(
      class ExpressionNode_SimpleExpression_Relop_SimpleExpression &node) = 0;

  virtual void visit(class SimpleExpressionNode &node) = 0;
  virtual void visit(class SimpleExpressionNode_Term &node) = 0;
  virtual void visit(
      class SimpleExpressionNode_SimpleExpression_Plus_Term &node) = 0;
  virtual void visit(
      class SimpleExpressionNode_SimpleExpression_Minus_Term &node) = 0;
  virtual void visit(
      class SimpleExpressionNode_SimpleExpression_Or_Term &node) = 0;
